...
define('APP_ID', '2690043424462125');
define('APP_SECRET', '6bb354f3689435aadf51be6c07032d78');
define('API_VERSION', 'v14.0');
define('FB_BASE_URL', 'https://www.facebook.com/');
define('BASE_URL', 'http://localhost/Alphamedia/wp-content/plugins/AME_Live/src/dash_board.php');
if(!session_id()){
    session_start();
}
